...
index 57f3d2a..be3cec3 100644
--- a/cloudify_premium/ha/resources/sudo_trampoline.py
+++ b/cloudify_premium/ha/resources/sudo_trampoline.py
@@ -74,6 +74,20 @@ def update_db_settings(config, data_dir, cloudify_db, cloudify_user,
...
@@ -212,6 +227,9 @@ update_db_settings.add_argument('--replication-user', required=True)
